...
public class Researchpaper implements Serializable {
     ...
     * 成果编号
     */
    @ExcelProperty(value = "成果编号",index = 1)
    private String achievementnumber;

    /**
     * 论文编号
     */
    @ExcelProperty(value = "论文编号",index = 2)
     ...
     * 期刊
     */
    @ExcelProperty(value = "期刊",index = 6)
    private String periodical;

    /**
     * 卷期
     */
    @ExcelProperty(value = "卷期",index = 7)
    private String volume;

    /**
     * 页码
     */
    @ExcelProperty(value = "页码",index = 8)
     ...
     * 收集情况
     */
    @ExcelProperty(value = "收集情况",index = 10)
     ...
     * 存储地址
     */
    @ExcelProperty(value = "存储地址",index = 12)
    private String url;
